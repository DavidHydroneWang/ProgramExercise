...
# assgin search area (SA) corner point locations based on image pixels.
...
class Search():
    """Bayessian Search & Rescue game with 3 search areas."""
    ...
    def __init__(self, name):
        ...
        self.area_actual = 0
        self.sailor_actual = [0, 0]  # as 'loacl' corrds within search area
    ...
    def draw_map(self, last_know):
        """Display basemap with scale, last know xy lcoation, search areas."""
        # draw the scale bar
        ...
        # post the last know location of the sailor
        cv.putText(self.img, '+', (last_know),
    ...
    def sail_final_location(self, num_search_areas):
        """return the actual x,y loaction of the missing sailor."""
...
def main():
    ...
    sailor_x, sailor_y = app.sail_final_location(num_search_areas=3)
    print('-' * 65)
    ...
    while True:
        ...
        app.revise_target_probs()  # use bayes's rule to update target probs
