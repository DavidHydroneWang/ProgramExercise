...
def main():
    ...
    # tokenize text string and run stylometric tests
    words_by_author = make_word_dict(strings_by_author)
    len_shortest_corpus = find_shortest_corpus(words_by_author)

    words_length_test(words_by_author, len_shortest_corpus)
...
def make_word_dict(strings_by_author):
    """return dictionary of tokenize words by corpus by author"""
...
def find_shortest_corpus(words_by_author):
    """returns length of shortest corpus"""
    word_count = []
...
def words_length_test(words_by_author, len_shortest_corpus):
...
def jaccard_test(words_by_author, len_shortest_corpus):
    ...
    for author in authors:
        ...
        print('Jaccard Simolarity for {} = {}'.format(author, jaccard_sim))
