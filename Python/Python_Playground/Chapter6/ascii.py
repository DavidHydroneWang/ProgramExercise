...
# http://pualbourke.net/dataformats/asciiart/
...
def convertImageToAscii(filename, cols, scale, moreLevels):
    """
    given image and dimensions (rows, cols), return as m*n list of Images
    """
    # declare globals
    ...
    # an ASCII images is a list of character strings
    aimg = []
    # generate the list of the tile dimensions
    for j in range(rows):
        y1 = int(j*h)
        y2 = int((j + 1)*h)
