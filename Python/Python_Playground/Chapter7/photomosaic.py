...
def createPhotomosaic(target_image, input_image, grid_size, reuse_images=True):
    """
    ...
    for img in target_images:
        ...
        output_images.append(input_image[match_index])
        # user feedback
...
def main():
    ...
    input_image = getImages(args.input_folder)

    # check if any valid input images find
    if input_image == []:
    ...
    if resize_input:
        ...
        dims = (int(target_image.size[0]/grid_size[0]),
                int(target_image.size[1]/grid_size[1]))
    ...
    # create photomosaic
    mosaic_image = createPhotomosaic(target_image, input_image, grid_size,
                                     reuse_images)
