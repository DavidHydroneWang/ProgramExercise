...
class MainWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.location_input = QLineEdit('Download')
    ...
    def start_download(self):
        ...
        downloader = DownlaodThread(self.location_input.text() or os.getcwd(),
