...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        usage='python3 ids_foil.py -t TARGET [-i IFACE] [-r SRC] [-c COUNT]'
    )
    parser.add_argument('-t', type=str, metavar='TARGET',
    ...
    parser.add_argument('-c', type=str, metavar='COUNT', default=1,
