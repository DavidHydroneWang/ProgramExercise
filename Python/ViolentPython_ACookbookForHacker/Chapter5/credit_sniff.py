...
def find_credit_card(pkt):
    ...
    america_re = re.findall(f'3[47][0-9]{13}', raw)
    master_re = re.findall(f'5[1-5][0-9]{14}', raw)
    visa_re = re.findall(f'4[0-9]{12}(?:[0-9]{3}?)', raw)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        help='specify interface to listen to'
    )
