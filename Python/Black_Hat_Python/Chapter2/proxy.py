...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
        ...
        # send if to our response handler
...
def sercer_loop(local_host, local_port, remote_host, remote_port,
                receive_first):
    ...
    while True:
        ...
        proxy_handler = threading.Thread(target=proxy_handler, args=(
...
def main():
    ...
    sercer_loop(local_host, local_port, remote_host, remote_port,
                receive_first)
