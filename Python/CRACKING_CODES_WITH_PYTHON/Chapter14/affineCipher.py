...
def main():
    myMessage = """'A computer would deserve to be called intelligent if it could deceive a human into
...
def checkKeys(keyA, keyB, mode):
    ...
    if keyA < 0 or keyB < 0 or keyB > len(SYMBOLS) - 1:
        sys.exit('Key A must be generator than 0 and Key B must be between 0 and %s.' % (len(SYMBOLS) - 1))
