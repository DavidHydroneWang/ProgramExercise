...
def main():
    ...
    # determine the possible valid ciphertext translation
    print('Hacking...')
...
def hackSimpleSub(message):
    ...
    for cipherword in cipherwordList:
        ...
        # intersect the new mapping with the existing intersected mappin
...
def decryptWithCipherletterMapping(ciphertext, letterMapping):
    ...
    # with any ambiguous decryped letters replaced with an _ underscore.
