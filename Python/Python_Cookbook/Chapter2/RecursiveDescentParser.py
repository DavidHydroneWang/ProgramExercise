...
class ExpressionEvaluator:
    ...
    def _accept(self, tokentype):
        'Test and consume the next token if it matches tokentype'
    ...
    def _expect(self, tokentype):
        'Consume next token if it matches tokentype or raise SyntaxError.'
...
class ExpressionTreeBuilder(ExpressionEvaluator):
    ...
    def factor(self):
        ...
        if self._accept('NUM'):
            ...
            raise SyntaxError(' Expecred NUMBER or LPAREN')
